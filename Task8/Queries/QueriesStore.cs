...
namespace Queries
{
    public static class QueriesStore
    {
        ...
        public static string Query3(int l, IEnumerable<string> str)
        {
            ...
            string result = str.FirstOrDefault(s => s.Length == l && char.IsDigit(s[0])) ?? "Not found";
            return result;
        }
        ...
        public static int Query4(char c, IEnumerable<string> str)
        {
            ...
            int count = str.Count(s => s.Length > 1 && s.StartsWith(c) && s.EndsWith(c));
            return count;
        }
        ...
        public static string Query6(IEnumerable<string> str)
        {
            ...
            string result = string.Concat(str.Select(s => s.FirstOrDefault()));
        ...
        public static IEnumerable<int> Query7(int k, IEnumerable<int> a)
        {
            ...
            IEnumerable<int> evenNumbers = a.Where(n => n % 2 == 0);
            IEnumerable<int> numbersGreaterThanK = a.Skip(k + 1);
            IEnumerable<int> result = evenNumbers.Except(numbersGreaterThanK);

            // Reverse the order of the elements in the resulting sequence.
        ...
        public static IEnumerable<string> Query8(int k, IEnumerable<string> a)
        {
            ...
            IEnumerable<string> result = a.Where(s => s.Length == k && char.IsDigit(s[s.Length - 1]))
                                .OrderBy(s => s);
        ...
        public static IEnumerable<int> Query9(int d, int k, IEnumerable<int> a)
        {
            ...
            IEnumerable<int> firstFragment = a.TakeWhile(n => n <= d);
            IEnumerable<int> secondFragment = a.Skip(k - 1);
            IEnumerable<int> result = firstFragment.Union(secondFragment);
        ...
        public static IEnumerable<string> Query10(IEnumerable<int> n)
        {
            ...
            IEnumerable<string> result = n.Where(num => num % 2 != 0)
        ...
        public static IEnumerable<char> Query11(IEnumerable<string> str)
        {
            ...
            IEnumerable<char> result = str.Select(s => s.Length % 2 == 1 ? s[0] : s[^1])
        ...
        public static IEnumerable<int> Query12(int k1, int k2, IEnumerable<int> a, IEnumerable<int> b)
        {
            ...
            IEnumerable<int> result = a.Where(num => num > k1)
                              .Concat(b.Where(num => num < k2))
                              .OrderBy(num => num);
        ...
        public static IEnumerable<string> Query13(IEnumerable<int> a, IEnumerable<int> b)
        {
            ...
            IEnumerable<string> result = a.SelectMany(numA => b.Where(numB => numA % 10 == numB % 10)
                                                      .Select(numB => $"{numA}-{numB}"));
        ...
        public static IEnumerable<string> Query14(IEnumerable<string> a, IEnumerable<string> b)
        {
            ...
            IEnumerable<string> result = a.SelectMany(strA => b.Where(strB => strA.Length == strB.Length)
                                                      .Select(strB => $"{strA}:{strB}"))
                                 .OrderBy(pair => pair.Split(':')[0])
                                 .ThenByDescending(pair => pair.Split(':')[1]);
        ...
        public static IEnumerable<string> Query15(IEnumerable<int> a)
        {
            ...
            IEnumerable<string> result = a.GroupBy(num => num % 10)
                                  .Select(group => $"{group.Key}: {group.Sum()}")
                                  .OrderBy(str => str.Split(':')[0]);
        ...
        public static IDictionary<uint, int> Query16(IEnumerable<Enrollee> enrollees)
        {
            ...
            IDictionary<uint, int> result = enrollees.GroupBy(enrollee => enrollee.YearGraduate)
                                            .ToDictionary(group => group.Key, group => group.Select(enrollee => enrollee.SchoolNumber)
                                                                                         .Distinct()
                                                                                         .Count())
